  ...
  return (
    <footer className=" container-padding py-10 bg-very-dark-blue">
      ...
      <div className="hidden lg:flex justify-between">
        ...
        <div className="flex w-[30%] justify-between px-10 py-10 text-white">
          <div className="flex flex-col gap-3">
            {footerLinks.slice(0, 4).map((item, i) => (
              <a key={i} href="#">
                {item}
        ...
        <div className="w-[30%] flex flex-col py-10 justify-between">
          <div className="flex gap-5">
            <input
              className="flex-1 rounded-3xl bg-white px-4 focus:outline-none"
              type="text"
          ...
          <span className="mt-3 text-dark-grayish-blue text-right text-[0.9rem]">
            Copyright 2020. All Rights Reserved
          </span>
        </div>
      </div>
